...
public class caseMethod07 {
    public static void main(String[] args) {
        ...
        int nilaiKehadiran1 = sc.nextInt();
        System.out.print("Masukkan Nilai Etika: ");
        int nilaiEtika1 = sc.nextInt();
        ...
        System.out.print("masukkan Nilai Kehadiran:");
        int nilaiKehadiran2 = sc.nextInt();
        System.out.print("Masukkan Nilai Etika: ");
        int nilaiEtika2 = sc.nextInt();
        ...
        System.out.println("Nilai Kehadiran: " + nilaiKehadiran1);
        System.out.println("Nilai Etika: " + nilaiEtika1);
        System.out.println();
        ...
        System.out.println("Nilai Kehadiran: " + nilaiKehadiran2);
        System.out.println("Nilai Etika: " + nilaiEtika2);
